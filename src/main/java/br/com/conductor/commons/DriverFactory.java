...
//			creatDriverIOS();
	...
	private static void creatDriverAndroid() {
		...
		capability.setCapability(MobileCapabilityType.APP,
				"/Users/lucas.borgato/eclipse-workspace/br.com.portador/src/main/resources/app-release-qa.apk");
...
//		capability.setCapability(MobileCapabilityType.NEW_COMMAND_TIMEOUT, "60");
//		capability.setCapability(MobileCapabilityType.APP,
//				"/Users/lucas.borgato/eclipse-workspace/br.com.portador/src/main/resources/app-release-qa (5).apk");
//
//		try {
